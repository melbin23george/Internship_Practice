...
class RockPaperScissor{
  public static void main(String args[]){
    ...
    else if((computerChoice.equals("Rock"))&&(userChoice.equals("Paper"))||(computerChoice.equals("Paper"))&&(computerChoice.equals("Scissor"))||(computerChoice.equals("Scissor"))&&(userChoice.equals("Rock"))){
